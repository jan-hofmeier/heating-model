...
from heating_model.src.mock_data import generate_mock_data
from heating_model.src.preprocessing import preprocess_data, apply_delays
from heating_model.src.physics import estimate_burner_power, calculate_energies
from heating_model.src.analysis import detect_steady_state
from heating_model.src.plotting import save_plots
...
def main():
    ...
    print("Done. Check 'heating_model/output/' for results.")
